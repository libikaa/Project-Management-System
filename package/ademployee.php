...
<body>
  ...
  <center><button class="block" onclick="location.href='insertemp.php'">INSERT EMPLOYEE</button></center>
  <br><br><br><br>
  <center><button class="block" onclick="location.href='employee.php'">VIEW EMPLOYEE</button></center>
</body>
</html>