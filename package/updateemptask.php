...
{
  $id=$_GET['id'];
  $sql="CALL p_t_ozu_emp_tasks_update($id,'".$_POST["tid"]."')";
  if(pg_query($con,$sql))
  {
    header("location: updateemptask.php?updated=1");
    header("location: ademptask.php");
  }
}
if(isset($_GET["updated"]))
{
  echo '<script>alert("Task id  updated")</script>';
}
?>
<!DOCTYPE html>
<html>
...
<h3 style="font-size: 25px"><center><strong>UPDATING IN EMP TASK TABLE</strong></center></h3>

<div class="container box">
  <form method ="post" action="">
    <div class="form-group"><center><strong>
      <label>Enter task id to be updated<pre></pre></label>
