...
<body>
  ...
  <center><button class="block" onclick="location.href='inserttask.php'">INSERT TASK</button></center>
  <br><br><br><br>
  <center><button class="block" onclick="location.href='task.php'">VIEW TASK</button></center>
</body>
</html>