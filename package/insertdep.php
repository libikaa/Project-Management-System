...
{
  $sql="CALL p_t_ozu_depts_insert('".$_POST["did"]."','".$_POST["name"]."','".$_POST["hid"]."')";
  if(pg_query($con,$sql))
  {
    header("location: insertdep.php?inserted=1");
    header("location:addepartment.php");
  }
}
...
<h3 style="font-size: 25px"><center><strong>INSERTING IN DEPARTMENT TABLE</strong></center></h3>

<div class="container box">
  <form method ="post" action="">
    <div class="form-group"><center><strong>
      <label>Enter Department id<pre></pre></label>
      <input style="background-color: rgba(100,100,100,0); " type="text" name="did" id="did" class="form-contanier"></center>
    </div>
    <div class="form-group"><center>
      <label>Enter Department name<pre></pre></label>
      <input style="background-color: rgba(100,100,100,0); " type="text" name="name" id="name" class="form-contanier"></center>
    </div>
    <br />
    <div class="form-group"><center>
      <label>Enter head id<pre></pre></label>
      <input style="background-color: rgba(100,100,100,0); " type="text" name="hid" id="hid" class="form-contanier"></center>
    </div>
    <br />
    <div class="form-group"><center>
