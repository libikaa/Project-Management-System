...
<div class="sidenav">
  ...
  <a href="login.php">Logout</a>
	...
	<center><h1>PROJECT TABLE</h1></center>
</head>
<body>
	<br><br><br><br><br><br><br>
	<center><button class="block" onclick="location.href='insertproj.php'">INSERT PROJECT</button></center>
	<br><br><br><br>
	<center><button class="block" onclick="location.href='project.php'">VIEW PROJECT</button></center>
</body>
</html>