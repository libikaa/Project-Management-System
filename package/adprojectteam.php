...
<div class="sidenav">
  ...
  <a href="login.php">Logout</a>
	...
	<center><h1>PROJECT TEAM TABLE</h1></center>
</head>
<body>
	<br><br><br><br><br><br><br>
	<center><button class="block" onclick="location.href='insertprojteam.php'">INSERT PROJECT TEAM</button></center>
	<br><br><br><br>
	<center><button class="block" onclick="location.href='projectteam.php'">VIEW PROJECT TEAM</button></center>
</body>
</html>