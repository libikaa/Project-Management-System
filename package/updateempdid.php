...
if(isset($_POST["sal_btn"]))
{
  ...
  if(pg_query($con,$sql))
  {
    header("location: updateempdid.php?updated=1");
    header("location: ademployee.php");
  }
}
if(isset($_GET["updated"]))
{
  echo '<script>alert("Department id updated")</script>';
}
?>
<!DOCTYPE html>
<html>
...
<h3 style="font-size: 25px"><center><strong>UPDATING DEPARTMENT ID</strong></center></h3>

<div class="container box">
  <form method ="post" action="">
    <div class="form-group"><center><strong>
      <label>Enter the department id to be updated<pre></pre></label>
      <input style="background-color: rgba(100,100,100,0);" type="text" name="did" id="did" class="form-container"></center>
    </div>
    <br />
