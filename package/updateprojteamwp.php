...
if(isset($_POST["insert_btn"]))
{
  $id=$_GET['id'];
  $id2=$_GET['id2'];
  $sql="CALL  p_t_ozu_teams_update_work_per($id,$id2,'".$_POST["tid"]."')";
  if(pg_query($con,$sql))
  {
    header("location: updateprojteamwp.php?updated=1");
    header("location: adprojectteam.php");
  }
}
if(isset($_GET["updated"]))
{
  echo '<script>alert("Work Percentage  updated")</script>';
}
?>
<!DOCTYPE html>
<html>
...
<h3 style="font-size: 25px"><center><strong>UPDATING IN PROJECT TEAM TABLE</strong></center></h3>

<div class="container box">
  <form method ="post" action="">
    <div class="form-group"><center><strong>
      <label>Enter work percentage to be updated<pre></pre></label>
