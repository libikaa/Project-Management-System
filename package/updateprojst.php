...
{
  $id=$_GET['id'];
  $sql="CALL p_t_ozu_projects_update_stat($id,'".$_POST["stat"]."')";
  if(pg_query($con,$sql))
  {
    header("location: updateprojst.php?updated=1");
...
<h3 style="font-size: 25px"><center><strong>UPDATING PROJECT STATUS</strong></center></h3>

<div class="container box">
  <form method ="post" action="">
    <div class="form-group"><center><strong>
      <label>Enter the status to be updated<pre></pre></label>
      <input style="background-color: rgba(100,100,100,0); "  type="text" name="stat" id="stat" class="form-container"></center>
    </div>
    <br />
